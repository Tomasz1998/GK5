...
public class Zajecia extends GLJPanel implements GLEventListener, KeyListener{
	...
	public void Corkscrew(GL2 gl2, int rad, int numberOfTurn)

	{
		...
		gl2.glBegin(GL2.GL_POLYGON);
			...
			{
				kat = i * angleIncrement * Math.PI;
				gl2.glColor3f(x/0.6f, (x+z)*z/0.4f, z/0.5f);
				x = (float) (rad * Math.cos(kat));
				z = (float) (rad * Math.sin(kat));
